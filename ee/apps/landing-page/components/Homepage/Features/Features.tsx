...
const features = [
  ...
  },
  {
    ...
    content: 'Invite your teammates to work on your snipers with you',
  },
  {
    Icon: ConditionIcon,
    title: 'Link to sub snipers',
    content: 'Reuse your snipers in different parent bots.',
  },
  {
    Icon: CalculatorIcon,
    title: 'Custom code',
  ...
  },
  {
    Icon: ShareIcon,
    title: 'Custom domain',
    content: 'Connect your sniper to the custom URL of your choice',
  },
  {
    Icon: FolderIcon,
    title: 'Folder management',
    content:
      'Organize your snipers in specific folders to keep it clean and work with multiple clients',
  },
]
      ...
      >
        <VStack>
          ...
          <Text
            ...
            data-aos="fade"
          >
            Sniper makes form building easy and comes with powerful features
          </Text>
        </VStack>
