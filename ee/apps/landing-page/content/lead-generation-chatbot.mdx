...
## Step-by-Step Setup Guide Using Sniper

1. **Create a New Sniper**: First, sign up and log in to Sniper. From the dashboard, create a new chatbot.

<Image
  src="/images/blog/lead-generation-chatbot/create-new-sniper.png"
  alt="How to create a new Sniper"
  width="2000"
  height="1019"
/>

2. **Create a Welcome Message**: Use the Sniper builder to design your conversation
   flow. Start with an engaging greeting to welcome users.

<Image
  src="/images/blog/lead-generation-chatbot/create-welcome-message.gif"
  alt="How to create a welcome message in Sniper"
  width="800"
  height="631"
/>
...
<Image
  ...
  alt="How to ask for an email in Sniper"
  width="800"
  height="631"
/>
...
<Image
  ...
  alt="How to send a response in a Google Sheets in Sniper"
  width="2000"
  height="857"
/>
...
Start boosting your sales today by creating your own lead generation with our [chatbot builder for lead generation](https://sniper/io).
