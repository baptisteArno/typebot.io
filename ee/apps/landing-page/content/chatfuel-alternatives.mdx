...
Typebot is an open-source chatbot builder that lets you create advanced conversational apps without coding. It uses a drag-and-drop interface with various building blocks like text bubbles, input fields, conditional logic, and integrations. You can even customize the look and feel.
...
It can be integrated on your website or on different messaging platforms like WhatsApp, Facebook Messenger, and more. Here is an example of a Typebt chatbot:

<Typebot id="lead-generation-0rbhgp3" />
...
- Paid plans ranging from $12.50 to $15.83 per month for the Communicator plan
- $32.50 to $40.83 per month for the Chatbots plan
- $20.83 per month for the Mailing plan
- Tidio+, the most comprehensive plan, starts at $394 per month
