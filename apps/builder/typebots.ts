...
//   const items = stepTypeHasItems(type) ? parseDefaultItems(type, id) : undefined
...
//   type: InputStepType.CHOICE | LogicStepType.CONDITION | IntegrationStepType | OctaStepType.OFFICE_HOURS | OctaWabaStepType | WOZStepType.ASSIGN,
//   stepId: string
// ): Item[] | undefined => {
//   switch (type) {
