...
export const NoteIcon = (props: IconProps) => (
  <Icon viewBox="0 0 50 50" {...featherIconsBaseProps} {...props}>
    <path d="M13 4c-4.959 0-9 4.041-9 9v24c0 4.959 4.041 9 9 9h24c4.959 0 9-4.041 9-9V13c0-4.959-4.041-9-9-9H13zm0 2h24c1.131 0 2.195.271 3.139.744l-1.801 2.938v1.414c1.01.913 3.787 2.717 5.662 3.494v1.877c-1.528-.522-4.409-1.958-6.346-3.733-1.082 1.818-2.91 4.934-4.634 8.266H14a1 1 0 1 0 0 2h18.033c-.664 1.36-1.291 2.71-1.81 4H14a1 1 0 1 0 0 2h15.479c-.571 1.721-.874 3.22-.739 4.281l-.092.184c-.698 1.001-2.512 1.518-3.638 1.523-.982.005-1.438-.32-2.106-.8C22.237 33.706 21.334 33 20 33c-1.333 0-2.232.673-3.014 1.143-.782.47-1.517.857-2.986.857a1 1 0 1 0 0 2c1.869 0 3.132-.612 4.016-1.143.883-.53 1.317-.857 1.984-.857s1.02.295 1.734.81c.715.516 1.77 1.186 3.286 1.178a8.167 8.167 0 0 0 2.648-.455 1 1 0 0 0 1.732-.097l.88-1.76C34.042 33.544 43.1 18.649 44 17.158V37c0 3.877-3.123 7-7 7H13c-3.877 0-7-3.123-7-7V13c0-3.877 3.123-7 7-7zm1 9a1 1 0 1 0 0 2h18a1 1 0 1 0 0-2H14z" />
  </Icon>
)
