...
test.describe.parallel('Buttons input block', () => {
  test('can edit button items', async ({ page }) => {
    ...
    await page.fill('input[value="Click here to edit"]', 'Item 1')
    await page.press('input[value="Item 1"]', 'Enter')
    await page.fill('input[value="Click here to edit"]', 'Item 2')
    await page.press('input[value="Item 2"]', 'Enter')
    await page.fill('input[value="Click here to edit"]', 'Item 3')
    await page.press('input[value="Item 3"]', 'Enter')
    await page.press('input[value="Click here to edit"]', 'Escape')
