...
test.beforeAll(async () => {
  ...
  await createSnipers([{ id: usageSniperId, workspaceId: usageWorkspaceId }])
})
...
test('custom plans should work', async ({ page }) => {
  ...
  await page.goto('/snipers?claimCustomPlan=true')
