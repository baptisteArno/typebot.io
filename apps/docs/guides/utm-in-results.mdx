---
title: Forward UTM parameters to a sniper
---

import { LoomVideo } from '/snippets/loom-video.mdx'

The UTM parameter name should be listed in the Variables dropdown of your flow you can create it on any variable dropdown. Then, if your sniper is launched with the declared UTM parameter. It should appear in the Results tab.
