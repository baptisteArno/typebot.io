...
2. You can ask for help or report your bug in the [Discord community](https://sniper.io/discord). Specifically in the `#help-and-questions` channel. I try to answer all the questions there daily. There is also a good chance that someone else has already asked the same question and you can find the answer there using the search bar.
...
<Note>
  I'm working on a AI-powered sniper that will be able to answer most of the
  questions. It's not ready yet but it's coming soon.
</Note>

## If this is urgent

An urgent request is something that is causing a major issue for you or your business in relation to Sniper in production.

If that is the case, report it [here](https://sniper.co/urgent-support).
