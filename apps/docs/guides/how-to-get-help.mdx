...
2. You can ask for help or report your bug in the [Discord community](https://zazubot.com/discord). Specifically in the `#help-and-questions` channel. I try to answer all the questions there daily. There is also a good chance that someone else has already asked the same question and you can find the answer there using the search bar.
