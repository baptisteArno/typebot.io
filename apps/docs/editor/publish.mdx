...
- "Close sniper to new responses": close your sniper and your users will see the following message: "This bot is now closed."
- "Unpublish sniper": mark the sniper as unpublished and your users will see the following message: "The bot you're looking for doesn't exist"
