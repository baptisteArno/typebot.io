...
The Chatwoot integration block allows you to open a Chatwoot widget to allow your user to directly talk to a human. It allows you to add a Live Chat layer on your sniper.
...
You can add these custom attributes that Sniper will automatically fill in for you:
