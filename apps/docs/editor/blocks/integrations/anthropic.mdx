...
Similarly to the OpenAI block, this integration comes with a convenient message type called **Dialogue**. It allows you to easily pass a sequence of saved assistant / user messages history to ClaudeAI:

<Frame>
  <img
    src="/images/blocks/integrations/anthropic/append-to-history.png"
    alt="ClaudeAI messages sequence"
  />
</Frame>

Then you can give the ClaudeAI block access to this sequence of messages:
...
<Frame>
  <img
    ...
    alt="ClaudeAI assistant message variable"
  />
</Frame>
