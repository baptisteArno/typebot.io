...
By default, the email will be sent from `notifications@get-sniper.com` with default content based on what your new lead has replied to. It will look like this:
