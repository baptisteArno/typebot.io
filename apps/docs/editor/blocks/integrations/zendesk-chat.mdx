...
<Frame>
  <img
    src="/images/blocks/integrations/zendesk-chat/zendesk-end-user-auth.png"
...
This action opens the Messenger window. It requires the Web Widget `Key` to be set. You can find the key by going to `Channels -> Messaging`, then click on the Web Widget you wish to configure. Scroll down to 'Installation' and expand that section. In the script code block, copy the `key` value and use that for the `Key` setting.

<Frame>
  <img
    src="/images/blocks/integrations/zendesk-chat/web-widget-config.png"
    alt="Web Widget Key"
  />
</Frame>
