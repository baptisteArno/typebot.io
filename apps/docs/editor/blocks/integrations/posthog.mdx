...
This action allows you to capture an event in Posthog. It requires the `Event Name` and `User ID`, and can optionally take a set of `Properties`, as well as Group information.
...
This action allows you to send a page view event to Posthog. It requires the User ID and can optionally take a set of `Properties`, such as such as $current_url, which will indicate the url for the page view.

<Frame>
  <img
    src="/images/blocks/integrations/posthog/pageview.png"
    alt="PageView"
  />
</Frame>
