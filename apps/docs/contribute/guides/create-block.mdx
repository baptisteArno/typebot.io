...
5. Add the block's SVG logo in `packages/forge/blocks/YOUR_BLOCK_NAME/logo.tsx`
...
Make sure to join our [Discord community](https://zazubot.com/discord) to participate to these weekly office hours.
