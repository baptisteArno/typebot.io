...
Creating a new block on Sniper is pretty easy and straightforward using our in-house framework [The Forge](../the-forge/overview).

<Note>
  If you are considering merging this new block to the official Sniper
  repository, make sure to open a [Github
  issue](https://github.com/baptisteArno/sniper.io/issues/new) first. This will
...
Make sure to check out other blocks implementations in the [packages/forge/blocks](https://github.com/baptisteArno/sniper.io/tree/main/packages/forge/blocks) folder.
...
Make sure to join our [Discord community](https://sniper.io/discord) to participate to these weekly office hours.
