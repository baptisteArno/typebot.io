...
2. Set up environment variables
   ...
   Check out the [Configuration guide](https://docs.flowdacity.com/self-hosting/configuration) if you want to enable more options
...
5. Start the builder and viewer
   ...
   By default, you can easily authenticate in the builder using the "Github Sign In" button. For other options, check out the [Configuration guide](https://docs.flowdacity.com/self-hosting/configuration)
