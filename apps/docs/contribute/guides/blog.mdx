...
The [official Sniper blog](https://sniper.io/blog) is a place where we share any ideas, original content related to the chatbot industry, and Sniper itself.

You are free to contribute to the blog or fix any typos you may find.

1. Head over to the [content folder](https://github.com/baptisteArno/sniper.io/tree/main/apps/landing-page/content) on the Github repo.
...
- The article should be related to chatbots, or Sniper.
...
- `Sniper`: To embed a sniper as a Standard component. Example: `<Sniper sniper="<YOUR_BOT_PUBLIC_ID>" />`. You can provide the same props as the [Standard component](../../deploy/web/libraries/react#standard).
...
- `Cta`: To display a call-to-action that redirects to Sniper. Example: `<Cta />`
