...
The theme tab allows you to customize the look of your sniper.

## Global

This section allows you to enable or disable the sniper branding, change the font and the background of your bot.
