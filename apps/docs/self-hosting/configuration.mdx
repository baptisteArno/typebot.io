...
| Parameter                                                         | Default | Description                                                                                                                                                                                                                                 |
| ----------------------------------------------------------------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DATABASE_URL <span style={{color: '#ef5151'}}>\*</span>           |         |  Transaction URL 'https://supabase.com/partners/integrations/prisma'                                                                                                                                                                        |
| DATABASE_DIRECT_URL <span style={{color: '#ef5151'}}>\*</span>             |         |  Session URL 'https://supabase.com/partners/integrations/prisma'                                                                                                                                                                            |
