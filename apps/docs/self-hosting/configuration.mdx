...
| NEXT_PUBLIC_TERMS_OF_SERVICE_URL <span style={{color: '#ef5151'}}>\*</span>           |         | The URL your privacy policy will point to. Should be the publicly accessible URL (i.e. `https://typebot.io/terms-of-service`)                                                                                                                           |
