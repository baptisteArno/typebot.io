...
| NEXT_PUBLIC_TERMS_OF_SERVICE_URL         |         | The URL your privacy policy is available at. Should be the publicly accessible URL                                                                                                |
| NEXT_PUBLIC_PRIVACY_POLICY_URL <span style={{color: '#ef5151'}}>\*</span>           |         | The URL your privacy policy will point to. Should be the publicly accessible URL (i.e. `https://typebot.io/privacy-policy`)                                                                                                                           |
...
| CUSTOM_OAUTH_ISSUER_URL      |                      | OAuth issuer URL (i.e. `https://auth.domain.com`)                                       |
