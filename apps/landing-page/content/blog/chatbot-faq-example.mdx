...
[Building an FAQ](./how-to-build-faq-chatbot.mdx) bot in Typebot focuses on designing a flow that solves problems instead of writing syntax. We will move from a blank canvas to a fully deployed AI agent using a visual interface that prioritizes speed and logic.
