...
**[Building an FAQ chatbot](./how-to-build-faq-chatbot.mdx) with Typebot is easier than you might think—and you don't need to be a coding expert to do it.** Let's walk through the steps to create a chatbot that can handle customer questions like a pro.
