...
**Instead of making users fill out a form or wait for a reply, the bot guides them through a conversation.** It can qualify leads, answer FAQs, book appointments, send order updates, [collect feedback](https://typebot.io/blog/collecting-customer-feedback-methods), or route complex questions to a human agent.
...
- **API pricing:** While you can use free chatbot builders to design your flows, Meta charges separately for the WhatsApp Business API. It uses a [pay-per-session model](https://typebot.io/blog/whatsapp-business-api-pricing) where you are billed for each 24-hour conversation window.

You don't need to worry about the technical registration steps just yet. We will walk through exactly how to build your [WhatsApp automation](https://typebot.io/blog/whatsapp-automation-chatbot) and connect it to the WhatsApp API in the next section.
...
<Info>
Want to see a complete walkthrough of building a WhatsApp chatbot from start to finish? [Create a WhatsApp chatbot](https://typebot.io/blog/create-whatsapp-chatbot) covers the entire process with real examples.
</Info>
