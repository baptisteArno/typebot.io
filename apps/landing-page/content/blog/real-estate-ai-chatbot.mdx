...
Typebot lets you create a comprehensive [FAQ database within the chatbot](https://typebot.io/blog/faq-chatbot). You input common questions and answers, which the chatbot accesses to deliver in a conversational manner.
