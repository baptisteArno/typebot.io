...
WhatsApp Business automated messages (also called automatic messages) are pre-programmed responses that send automatically based on triggers, such as new contacts, time schedules, or customer actions.
...
Not every business needs the same level of WhatsApp automation. Your best option depends on team size, message volume, budget, and how technical your setup can be. 

<Success>
Comparing the free WhatsApp Business App, the official Business API, and third-party tools side by side helps you avoid overpaying for features you will not use—or underestimating what you need once conversations start scaling.
</Success>
...
### How to Automate WhatsApp Messages for Free (With Free Tools)

Many businesses want to start with zero investment. Here's how you can automate WhatsApp messages completely free using free WhatsApp automation tools:
...
We'll cover three approaches: built-in Business App tools, the WhatsApp Business API, and a middle-ground using Typebot. Choose based on your business size and technical comfort.

## 1. How to Set Up WhatsApp Business Automation in the Free App
...
2. Ensure you have a [dedicated business phone number](https://www.calilio.com/business-phone-number) (cannot use a personal WhatsApp number)
...
### Step 3: Configure automatic greeting, away, and quick-reply messages
...
## 2. How to Set Up WhatsApp Business API Automation
...
## 3. Setting Up Typebot with WhatsApp
...
**Multi-touch follow-up automation sequences:**
...
**How do I send automatic messages on WhatsApp Business?**

On the free WhatsApp Business app, set greeting messages, away messages, and quick replies under Business tools. These send automatic messages for new chats, after-hours contacts, and common questions. For true auto-send beyond those built-in replies (order updates, multi-step flows, or triggered sequences), use the WhatsApp Business API or a no-code tool like Typebot connected to WhatsApp.