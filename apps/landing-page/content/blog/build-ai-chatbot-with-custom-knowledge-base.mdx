...
postedAt: "2025-02-10"
cover: "/blog-assets/build-ai-chatbot-with-custom-knowledge-base/featured-image-build-ai-chatbot-with-custom-knowledge-base.avif"
author: younes
---
...
In this guide, we’ll use two [open-source tools](https://typebot.io/blog/open-source-chatbots): **Flowise** and **Typebot**. Flowise connects to various LLMs to handle AI processing, while Typebot provides an intuitive interface for creating conversational flows without coding.
...
Integrating AI chatbots with custom knowledge bases creates a **Retrieval-Augmented Generation (RAG) system**, [offering several advantages](https://typebot.io/blog/benefits-ai-chatbot):
...
<Image src="https://writer-app-images.s3.eu-west-3.amazonaws.com/typebot/build-ai-chatbot-with-custom-knowledge-base/render-deployment-type.avif" alt="Render Deployment Type" width="320px" height="349px" />


1. Paste the public Flowise repository URL: https://github.com/FlowiseAI/Flowise

<Image src="https://writer-app-images.s3.eu-west-3.amazonaws.com/typebot/build-ai-chatbot-with-custom-knowledge-base/configure-flowise-deployment-render.avif" alt="Configure Flowise Deployment on Render" width="1423px" height="327px" />


2. Then, most of the settings will apply automatically
3. Add these environment variables:

<Image src="https://writer-app-images.s3.eu-west-3.amazonaws.com/typebot/build-ai-chatbot-with-custom-knowledge-base/render-auth-environment-variables.avif" alt="Render Auth Environment Variables" width="1381px" height="544px" />
...
<Image src="https://writer-app-images.s3.eu-west-3.amazonaws.com/typebot/build-ai-chatbot-with-custom-knowledge-base/cronjob-create-cron.avif" alt="Cronjob Create Cron" width="1283px" height="249px" />
...
1. Configure the job:
   ...
   - **URL**: Your Render.com Flowise URL. You can find it on the Render dashboard
     ...
     <Image src="https://writer-app-images.s3.eu-west-3.amazonaws.com/typebot/build-ai-chatbot-with-custom-knowledge-base/render-service-url.avif" alt="Render Service Url" width="630px" height="198px" />
...
<Image src="https://writer-app-images.s3.eu-west-3.amazonaws.com/typebot/build-ai-chatbot-with-custom-knowledge-base/cronjob-configuration.avif" alt="Cronjob Configuration" width="1280px" height="1055px" />
...
<Image src="https://writer-app-images.s3.eu-west-3.amazonaws.com/typebot/build-ai-chatbot-with-custom-knowledge-base/example-notion-knowledge-base.avif" alt="Example Notion Knowledge Base" width="1156px" height="559px" />
...
1. **Add the Notion Loader**:
   ...
   <Image src="https://writer-app-images.s3.eu-west-3.amazonaws.com/typebot/build-ai-chatbot-with-custom-knowledge-base/select-notion-loader-flowise.avif" alt="Select Notion Loader Flowise" width="409px" height="609px" />
...
<Image src="https://writer-app-images.s3.eu-west-3.amazonaws.com/typebot/build-ai-chatbot-with-custom-knowledge-base/notion-loader-with-markdown-splitter.avif" alt="Notion Loader With Markdown Splitter" width="1189px" height="859px" />
...
<Image src="https://writer-app-images.s3.eu-west-3.amazonaws.com/typebot/build-ai-chatbot-with-custom-knowledge-base/flowise-complete-flow.avif" alt="Flowise Complete Flow" width="1492px" height="1238px" />
...
<Image src="https://writer-app-images.s3.eu-west-3.amazonaws.com/typebot/build-ai-chatbot-with-custom-knowledge-base/upsert-knowledge-base-flowise.avif" alt="Upsert Knowledge Base Flowise" width="152px" height="88px" />


3. Use the **"Predict"** tab to test the flow with sample questions.
4. Navigate to the **Code icon** to get your endpoint URL.

<Image src="https://writer-app-images.s3.eu-west-3.amazonaws.com/typebot/build-ai-chatbot-with-custom-knowledge-base/get-endpoint-from-flowise.avif" alt="Get Endpoint From Flowise" width="459px" height="232px" />
...
<Info>
	Want to explore real-world chatbot script examples that can inspire your custom AI chatbot design? [Check out these practical script templates](https://typebot.io/blog/chatbot-script-examples)
...
- Configure the request like so:
  ...
  <Image src="https://writer-app-images.s3.eu-west-3.amazonaws.com/typebot/build-ai-chatbot-with-custom-knowledge-base/typebot-http-request-config.avif" alt="Typebot Http Request Config" width="800px" height="1204px" />
...
<Image src="https://writer-app-images.s3.eu-west-3.amazonaws.com/typebot/build-ai-chatbot-with-custom-knowledge-base/typebot-flow-using-flowise.avif" alt="Typebot Flow Using Flowise" width="1300px" height="741px" />
