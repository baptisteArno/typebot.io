...
Typebot is an open-source, no-code [chatbot builder](./best-chatbot-builder.mdx)—and arguably the best Botpress free alternative available today. 

It's designed for teams that want to create, customize, and deploy conversational experiences. Plus, the platform is fast and [requires zero coding](./ai-open-source-tools.mdx). Typebot stands out for its intuitive visual builder, deep theming, and flexible deployment options.
...
- **Conditional Logic & Personalization:** Add branching, variables, and user data capture with a click. Personalize flows based on user answers or external data. You can create bots that adapt to each user, boosting engagement and conversion.
  <Image src="/blog-assets/botpress-alternative/logic-menu-options-list.avif" alt="Logic Menu Options List" width={496} height={447}  />
...
<Image src="/blog-assets/botpress-alternative/typebot-chat-interface-design.avif" alt="Typebot Chat Interface Design" width={1200} height={512}  />
...
<Image src="/blog-assets/botpress-alternative/bot-building-interface.avif" alt="bot building interface" width={1200} height={532}  />
...
<Image src="/blog-assets/botpress-alternative/whatsapp-automation-setup-guide.avif" alt="Whatsapp Automation Setup Guide" width={1200} height={388}  />
...
<Image src="/blog-assets/botpress-alternative/agentic-workflow-diagram-interface.avif" alt="agentic workflow diagram interface" width={1200} height={648}  />
...
<Image src="/blog-assets/botpress-alternative/ai-agent-workflow-diagram.avif" alt="Ai Agent Workflow Diagram" width={1200} height={564}  />
...
<Image src="/blog-assets/botpress-alternative/tidio-dashboard-user-interface.avif" alt="Tidio Dashboard User Interface" width={1200} height={565}  />
...
<Image src="/blog-assets/botpress-alternative/chatbot-website-settings-screen.avif" alt="chatbot website settings screen" width={1200} height={650}  />
...
If you're searching for a Botpress free alternative, open-source options like Typebot and Flowise let you get started at zero cost—with the flexibility to self-host and scale without per-seat fees.
| Platform    | Entry price (monthly) | Free tier              | Self-hosting | Best for                | Cost drivers              |
| ----------- | --------------------- | ---------------------- | ------------ | ----------------------- | ------------------------- |
| Typebot     | Free / $39+           | Yes (200 chats/mo)     | Yes          | No-code teams, startups | Chats, seats              |
| Landbot     | Free / $45+           | Yes (100 chats/mo)     | No           | Lead gen, WhatsApp      | Chats, AI usage, channels |
| Chatfuel    | $69                   | 7-day trial only       | No           | Social media, WhatsApp  | Flat rate                 |
| Flowise     | Free / $35+           | Yes (self-host)        | Yes          | Developers, AI agents   | Cloud usage, support      |
| Voiceflow   | Custom pricing        | Free trial             | No           | Voice bots, enterprise  | Seats, usage              |
| Tidio       | Free / $24+           | Yes (50 conversations) | No           | E-commerce, live chat   | Conversations, AI chats   |
| Chatbot.com | $19+                  | 14-day trial only      | No           | SMBs, web support       | Users, AI resolutions     |
