---
title: "How to Build Lead Qualification Automations in 2026 (with examples)"
...
<Image src="/blog-assets/automated-lead-qualification/workflow-builder-ui-design.avif" alt="Workflow Builder Ui Design" width={1200} height={632}  />
...
Here is how to build a smart bot that [gathers lead information and uses AI](./ai-lead-qualification.mdx) to instantly qualify them. This will save you and your team valuable time.
...
<Image src="/blog-assets/automated-lead-qualification/create-new-typebot-options.avif" alt="Create New Typebot Options" width={431} height={280}  />
...
<Image src="/blog-assets/automated-lead-qualification/flow-chart-design-interface.avif" alt="Flow Chart Design Interface" width={448} height={265}  />
...
<Image src="/blog-assets/automated-lead-qualification/email-input-arrow-group-3.avif" alt="Email Input Arrow Group 3" width={683} height={264}  />
...
- "101-200 employees" Save the user's choice to a variable named `company_size`.
  <Image src="/blog-assets/automated-lead-qualification/company-size-selection-options.avif" alt="Company Size Selection Options" width={224} height={400}  />


1. **Learn Their Project Needs**: Connect a new Text input block to the previous one. Set the placeholder to "Briefly describe your project goals or needs..." and save the answer to a variable called `project_needs`.
2. **Send Data to Make.com for Lead Qualification**

- From the Integrations panel, drag a Make.com block onto the canvas and connect it after the project needs input.

<Image src="/blog-assets/automated-lead-qualification/flowchart-integration-make-com.avif" alt="Flowchart Integration Make Com" width={1200} height={538}  />


- Go to account settings from Typebot, then create an API token.

<Image src="/blog-assets/automated-lead-qualification/account-create-api-token.avif" alt="Account Create Api Token" width={1200} height={609}  />


- In Make.com, create a scenario with Typebot.

<Image src="/blog-assets/automated-lead-qualification/typebot-app-integration-screen.avif" alt="Typebot App Integration Screen" width={1200} height={562}  />


- Add your API key here.

<Image src="/blog-assets/automated-lead-qualification/typebot-create-connection-modal.avif" alt="Typebot Create Connection Modal" width={1200} height={605}  />
...
<Image src="/blog-assets/automated-lead-qualification/webhook-executed-successfully.avif" alt="Webhook Executed Successfully" width={632} height={197}  />
...
<Image src="/blog-assets/automated-lead-qualification/hubspot-crm-settings-panel.avif" alt="Hubspot Crm Settings Panel" width={1047} height={1200}  />


- Run the scenario and done! The data will be added automatically to your CRM!

<Image src="/blog-assets/automated-lead-qualification/contacts-management-page-interface.avif" alt="Contacts Management Page Interface" width={1200} height={196}  />
