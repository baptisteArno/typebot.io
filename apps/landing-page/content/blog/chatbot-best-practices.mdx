...
<Success>
  Check our article on how to [build a chatbot with custom knowledge base](https://typebot.io/blog/build-ai-chatbot-with-custom-knowledge-base) to lean how to implement personalization and interconnectivity in your chatbot.
</Success>
