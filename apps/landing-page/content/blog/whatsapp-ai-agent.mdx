...
<Info>
To have more details on creating chatbots that leverage a custom knowledge base, check out our article on [building an AI chatbot with a custom knowledge base](https://typebot.io/blog/build-ai-chatbot-with-custom-knowledge-base).
</Info>
