...
For example, a [real estate chatbot](./real-estate-ai-chatbot.mdx) might calculate mortgage estimates using user inputs for income, down payment, and loan term. All within the conversation flow.
