...
<Image
  src="/images/blog/create-whatsapp-chatbot/typebot-blocs.png"
  alt="All blocs offered by Typebot"
  width={318}
  height={535}
/>
...
<Image
  src="/images/blog/create-whatsapp-chatbot/flow-first-message.png"
...
<Image
  src="/images/blog/create-whatsapp-chatbot/flow-first-ask.png"
  alt="Bloc that asks for feedback type"
  width={344}
  height={274}
/>
...
<Image
  src="/images/blog/create-whatsapp-chatbot/flow-ask-email.png"
  alt="Bloc that asks for email and feedback"
  width={800}
  height={493}
/>
...
3. On the “Use case” step, select “Other”
   ...
   <Image
     src="/images/blog/create-whatsapp-chatbot/whatsapp-create-app-type.png"
...
4. On the next step, select Business
   ...
   <Image
     src="/images/blog/create-whatsapp-chatbot/whatsapp-create-app-business.png"
...
5. Next step asks you about details of your app such as the name and your email
   ...
   <Image
     src="/images/blog/create-whatsapp-chatbot/whatsapp-create-app-details.png"
...
<Image
  src="/images/blog/create-whatsapp-chatbot/result-example.png"
...
<Image
  src="/images/blog/create-whatsapp-chatbot/typebot-share-button.png"
...
1. Click on the "Preview" button in the Typebot editor.
2. Change the runtime to "WhatsApp."

   <Image
     src="/images/blog/create-whatsapp-chatbot/typebot-preview-whatsapp.png"
...
For example, you can use the `{{waba.name}}` variable to personalize your chatbot's greetings and responses with the user's name. This simple touch can make the experience feel more human and tailored to the individual.

Similarly, the `{{waba.phone}}` variable can pre-populate input fields or integrate with systems that require the user's phone number, streamlining the overall experience.
