...
export const Testimonials = () => {
  return (
    <div className="flex flex-col gap-8 items-center">
      ...
      <div className="flex flex-col rounded-2xl overflow-y-auto max-h-[50vh] bg-gray-1 border relative w-full">
        <div className="pointer-events-none top-0 h-10 w-full bg-gradient-to-t from-gray-2/10 to-gray-2/90 sticky flex-shrink-0 z-10" />
        <div className="flex flex-col gap-6 items-center px-4">
          {testimonials.map((testimonial) => (
            <Testimonial key={testimonial.name} {...testimonial} />
          ))}
        </div>
        <div className="pointer-events-none bottom-0 h-10 w-full bg-gradient-to-b from-gray-2/10 to-gray-2/90 sticky flex-shrink-0" />
      </div>
    </div>
  );
};
...
const Testimonial = ({
  ...
  return (
    <div className="flex gap-2">
      ...
      <div className="flex flex-col bg-gray-2 p-4 rounded-xl gap-4">
        <p>{content}</p>
        <hr />
