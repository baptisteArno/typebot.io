...
function RouteComponent() {
  return (
    <CommonPageLayout>
      <div className="flex flex-col max-w-6xl mx-auto gap-20 md:gap-32 pt-32 md:pt-16 w-full pb-20 md:pb-32 px-4">
        <div className="max-w-3xl mx-auto gap-16 flex flex-col">
          ...
          <div className="flex flex-col gap-10 font-heading text-3xl md:text-justify">
            ...
            <p>
              ...
              messaging apps because it's natural, engaging, and familiar.{" "}
              <br />
              We think businesses should tap into this same dynamic because
              where{" "}
            ...
            <p>
              ...
              that go beyond scripted responses. Our mission is to transform
              cold, transactional chats into lively conversations that reflect
              the true voice of your brand.
            </p>
            <p>
              Typebot{" "}
