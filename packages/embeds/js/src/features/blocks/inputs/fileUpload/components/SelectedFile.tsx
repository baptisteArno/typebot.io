...
export const SelectedFile = (props: {
  ...
  return (
    <div class="relative group flex-shrink-0">
      ...
      <button
        class="absolute -right-2 p-0.5 -top-2 rounded-full bg-input-bg text-input-text border border-input-border opacity-1 sm:opacity-0 group-hover:opacity-100 transition-opacity"
