...
import { AudienceCreateInputStandardSchema } from "../core/Audience";

export const CreateAudienceForm = ({
  onValidSubmit,
  initialFocusRef,
}: {
  onValidSubmit: (input: AudienceCreateInputSchema) => Promise<void>;
  ...
  const form = useForm({
    ...
    validators: {
      onSubmit: AudienceCreateInputStandardSchema,
    },
