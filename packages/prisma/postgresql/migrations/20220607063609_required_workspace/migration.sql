/*
  ...
  - Made the column `workspaceId` on table `Sniper` required. This step will fail if there are existing NULL values in that column.
...
-- AlterTable
ALTER TABLE "Sniper" ALTER COLUMN "workspaceId" SET NOT NULL;
