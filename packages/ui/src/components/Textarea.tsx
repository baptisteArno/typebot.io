...
export const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(
  ({ className, size = "default", onValueChange, ...props }, ref) => (
    <textarea
      ...
      data-slot="textarea"
      className={cn(
        "rounded-md border bg-gray-1 max-w-sm w-full px-4 py-2.5 outline-hidden ring-orange-7 transition-[color,border-color,box-shadow] focus:border-orange-8 focus:ring-2",
