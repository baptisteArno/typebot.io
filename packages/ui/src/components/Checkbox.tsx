  ...
  return (
    ...
    >
      <CheckboxPrimitive.Indicator
        ...
        className="absolute -inset-px flex items-center justify-center rounded-[0.25rem] text-gray-1 data-[checked]:bg-orange-9 data-[indeterminate]:text-gray-12 data-[unchecked]:hidden"
        render={(props, state) => (
          <span {...props}>
            {state.indeterminate ? (
              <svg
